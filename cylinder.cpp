...
auto main () -> int {
    ...
    const auto cylinder_interactor_style = vtkSmartPointer<vtkInteractorStyleTrackballCamera>::New();
    const auto cylinder_interator = vtkSmartPointer<vtkRenderWindowInteractor>::New();
