...
constexpr std::array<int, 12> data_2008{10822, 10941, 9979,  10370, 9460, 11228,
                                        15093, 12231, 10160, 9816,  9384, 7892};
constexpr std::array<int, 12> data_2009{9058,  9474,  9979,  9408, 8900, 11569,
                                        14688, 12231, 10294, 9585, 8957, 8590};
constexpr std::array<int, 12> data_2010{9058,  10941, 9979,  10270, 8900, 11228,
...
auto main(int, char*[]) -> int {
  ...
  auto line = chart->AddPlot(vtkChart::BAR);
